...
from openvla_model import OPENVLAInference
...
def main():
    ...
    if args.client:
        ...
        for i in range(args.num_episodes):
            ...
            print(f"Episode {i + 1} of {args.num_episodes}... starting client...")
            ...
            os.makedirs(f'images/episode_{i}', exist_ok=True)

            # This ensures that the robot is ready to be controlled
            for j in range(args.num_steps):
                
                print(f"Step {j + 1}: Taking observation...")
                ...
                img.save(f'images/episode_{i}/test_{j}.jpg')
